...
More information about Android identifier best practices can be found in the [Android user data and identifiers documentation](https://developer.android.com/training/articles/user-data-ids).
